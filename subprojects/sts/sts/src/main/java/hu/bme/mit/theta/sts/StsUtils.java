...
public final class StsUtils {
    ...
    /**
     * Transform STS into a new STS, where the initial and transition formula is in an
     * equisatisfiable CNF form. The property is not transformed (as it may be negated).
     *
     * @param sts Original STS
     * @return Transformed STS
     */
